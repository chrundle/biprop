...
# Imagenet Networks
def ResNet18_BinAct_v2(pretrained=False):
    return ResNet_BinAct(get_builder(), BasicBlock, [2, 2, 2, 2], 1000)

def ResNet34_BinAct_v2(pretrained=False):
    return ResNet_BinAct(get_builder(), BasicBlock, [3, 4, 6, 3], 1000)

def ResNet50_BinAct_v2(pretrained=False):

...
# Activation function from BiReal-Net
import torch
...
class Builder(object):
    ...
    def group_conv3x3(self, in_planes, out_planes, groups, stride=1, first_layer=False):
    ...
    def group_conv1x1(self, in_planes, out_planes, groups, stride=1, first_layer=False):
